...
mongoose
  .connect("mongodb+srv://mlookakel:mlook@cluster0.pjt13ng.mongodb.net/", {
...
const sendVerificationEmail = async (email, verificationToken) => {
  ...
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "Abdulmalek.akel@gmail.com",
      pass: "ijgx uuog cdeh stnc", 
    },
  });
  ...
  const mailOptions = {
    ...
    text: `please click the following link to verify your email http://192.168.56.1:3000/verify/${verificationToken}`,
  };
